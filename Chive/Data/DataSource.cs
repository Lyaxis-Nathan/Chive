...
namespace Chive.Data
{
    public class SprintManagmentModel
    {
        ...
        /// <summary>
        /// Converts a decimal value to a mixed fraction string representation.
        /// </summary>
        /// <param name="value">The decimal value to convert.</param>
        /// <returns>
        /// A string representing the value as a mixed fraction (e.g., "1 1/2" for 1.5).
        /// If the value is a whole number, returns the whole number as a string.
        /// </returns>
        public static string ToMixedFraction(decimal value)
        {
            int whole = (int)value;
            decimal fraction = Math.Abs(value - whole);

            if (fraction == 0)
                return whole.ToString();

            // Find denominator (up to 1000 for reasonable precision)
            int denominator = 1;
            while ((fraction * denominator) % 1 != 0 && denominator <= 1000)
                denominator++;
    ...
    {
        /// <summary>
        /// Validates the status and progress of a task to ensure consistency.
        /// </summary>
        /// <param name="value">The value of the property being validated.</param>
        /// <param name="validationContext">The context information about the validation operation.</param>
        /// <returns>
        /// A <see cref="ValidationResult"/> indicating whether the validation succeeded.
        /// Returns an error message if the status and progress are inconsistent.
        /// </returns>
